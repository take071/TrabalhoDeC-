...
// =============================================
//  Construtor - zera todos os contadores
// =============================================
...
// =============================================
//  Registrar uma recomendacao feita
// =============================================
...
// =============================================
//  Exibir relatorio completo de estatisticas
// =============================================
void Estatisticas::exibirEstatisticas(ListaSimples &catalogo, ListaDupla &historico) {
    ...
    // --- Total de recomendacoes e visualizacoes ---
...
void Estatisticas::avaliarConteudo(ListaSimples &catalogo) {
    ...
    if (estrelas < 1 || estrelas > 5) {
        cout << "\n Avaliacao invalida! Use valores de 1 a 5.\n";
        return;
    }
    ...
    cout << "\n Avaliacao registrada! Nova media:";
    exibirEstrelas(c->avaliacao);
    cout << "\n";
}

// =============================================
//  Listar conteudos ordenados por avaliacao
// =============================================
void Estatisticas::listarPorAvaliacao(ListaSimples &catalogo) {
    ...
    // (nao altera a lista, apenas imprime na ordem)
