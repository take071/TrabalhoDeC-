...
// =============================================
//  Construtor - inicializa e constroi a arvore
// =============================================
...
// =============================================
//  Construir a arvore de decisao (6+ niveis)
//
//  Nivel 0: Prefere filmes ou series?
//  Nivel 1: Genero preferido?
//  Nivel 2: Sub-genero ou epoca?
//  Nivel 3: Popularidade ou detalhe?
//  Nivel 4: Especificidade final
//  Nivel 5: Folhas com recomendacoes
// =============================================
...
// =============================================
//  Navegar pela arvore interativamente
//  Ao chegar na folha, seta tipo e genero
// =============================================
void ArvoreDecisao::navegar(NodoDecisao* no, Tipo &tipoResult, Genero &generoResult, FiltroAno &filtroAnoResult) {
    ...
    // Se e folha, definimos os filtros de resultado
    if (no->ehFolha) {
...
// =============================================
//  Prepara impressao da arvore
// =============================================
void ArvoreDecisao::imprimirArvore() {
    cout << "\n===== ARVORE DE DECISAO (2D) =====\n";
    cout << "(Esq=Sim / Dir=Nao | [] = folha)\n";
    imprimir(raiz, 0);
    cout << "\n";
}
